...
public class Simulator extends JFrame implements ActionListener {
	...
	private JLabel lupa;
	private JMenuItem mntmLupa;
	private JMenuItem mntmMeniuPrincipal;
	...
	public Simulator(int nr_circuit, int nr_masina) {
		...
		JMenu mnFila = new JMenu("Fila");
		menuBar.add(mnFila);
		
		JMenuItem mntmAlegeAltaConfiguratie = new JMenuItem("Alege alta configuratie");
		mntmAlegeAltaConfiguratie.addActionListener(new ActionListener() {
		...
		mntmAlegeAltaConfiguratie.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
			}
		});
		mnFila.add(mntmAlegeAltaConfiguratie);
		
		mntmLupa = new JMenuItem("Lupa");
		mntmLupa.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(mntmLupa.getText() == "Lupa")
				{
					lupa.setVisible(true);
					mntmLupa.setText("Ascunde lupa");
				}
				else
				{
					lupa.setVisible(false);
					mntmLupa.setText("Lupa");
				}
			}
		});
		mnFila.add(mntmLupa);
		...
		mntmMeniuPrincipal = new JMenuItem("Meniu principal");
		mntmMeniuPrincipal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		btnTimer.setBounds(10, 515, 90, 25);
		...
		lupa = new JLabel("");
		lupa.setBounds(215, 465, 300, 120);
		lupa.setVisible(false);
		...
		Timer t3 = new Timer(100, new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				try {
					...
					Rectangle rect = new Rectangle(getBounds().x + m.getX(), getBounds().y + m.getY() + 30, 150, 100);
