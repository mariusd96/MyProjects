	...
	public GUI(String nume)
	{
		...
		adunare.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				String mesaj = polinomH.toString();
		...
		impartire.addActionListener(new ActionListener(){
			...
			{				
				...
				if(rezultat == 0) 
				{
					polinomH = polinomF.imparteCu(polinomG);
					aux = polinomH.inmultesteCu(polinomG);
					polinomR = polinomF.scadeCu(aux);
				}
				else 
				{
					polinomH = polinomG.imparteCu(polinomF);
					aux = polinomH.inmultesteCu(polinomF);
					polinomR = polinomG.scadeCu(aux);
				}
				...
				String mesaj2 = polinomR.toString();
