...
{
    public partial class S_Asia : Form
    {
        ...
        public S_Asia()
        {
            ...
            for (int i = 1; i <= 47; i++)
            {
                bp[i] = new Bitmap("Resurse/Steaguri/Asia/imagine" + i.ToString() + ".png");
        ...
        private void done_Click(object sender, EventArgs e)
        {
            if (x == 1)
            {
                ...
                {//cand n este 48 inseamna ca am parcurs toate tarile
                    ...
                    steag.Image = Properties.Resources.Asia;//la final o imagine reprezentativa pt Asia
                }
            }
            if (x == 0)
