...
{
    public partial class S_Europa : Form
    {
        Bitmap[] bp = new Bitmap[50];//vectorul de imagini cu steaguri
        ...
        public S_Europa()
        {
            ...
            for (int i = 1; i <= 47; i++)
            {
                bp[i] = new Bitmap("Resurse/Steaguri/Europa/imagine" + i.ToString() + ".png");
        ...
        private void done_Click(object sender, EventArgs e)
        {
            if (x == 1)
            {
                ...
                {//cand n este 48 inseamna ca am parcurs toate tarile
                    ...
                    steag.Image = Properties.Resources.Europa1;//la final o imagine reprezentativa pt Europa
                }
            }
            if (x == 0)
