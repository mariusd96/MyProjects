...
{
    public partial class S_Oceania : Form
    {
        Bitmap[] bp = new Bitmap[10];//vectorul de imagini cu steaguri
        ...
        public S_Oceania()
        {
            ...
            for (int i = 1; i <= 8; i++)
            {
                bp[i] = new Bitmap("Resurse/Steaguri/Oceania/imagine" + i.ToString() + ".png");
        ...
        private void done_Click(object sender, EventArgs e)
        {
            if (x == 1)
            {
                ...
                {//cand n este 9 inseamna ca am parcurs toate tarile
                    ...
                    steag.Image = Properties.Resources.wa_pinnacles_nambung_national_park;//la final o imagine reprezentativa pt Oceania
                }
            }
            if (x == 0)
