...
{
    public partial class TCS_Africa : Form
    {
        Bitmap[] bp = new Bitmap[60];//vectorul de imagini
        ...
        public TCS_Africa()
        {
            ...
            for (int i = 1; i <= 54; i++)
            {
                bp[i] = new Bitmap("Resurse/harti+steaguri/Africa/imagine" + i.ToString() + ".png");
        ...
        private void done_Click(object sender, EventArgs e)
        {
            if (x == 1)
            {
                ...
                {//cand n este 55 inseamna ca am parcurs toate tarile
                    ...
                    steag.BackgroundImage = Properties.Resources.marakele_national_park_south_africa_wallpaper;//la final o imagine reprezentativa pt Africa
