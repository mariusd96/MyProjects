...
{
    public partial class TCS_AmericaN : Form
    {
        Bitmap[] bp = new Bitmap[30];//vectorul de imagini
        ...
        public TCS_AmericaN()
        {
            ...
            for (int i = 1; i <= 23; i++)
            {
                bp[i] = new Bitmap("Resurse/harti+steaguri/AmericaN/imagine" + i.ToString() + ".png");
        ...
        private void done_Click(object sender, EventArgs e)
        {
            if (x == 1)
            {
                ...
                {//cand n este 24 inseamna ca am parcurs toate tarile
                    ...
                    steag.BackgroundImage = Properties.Resources.America_de_N;//la final o imagine reprezentativa pt America de Nord
