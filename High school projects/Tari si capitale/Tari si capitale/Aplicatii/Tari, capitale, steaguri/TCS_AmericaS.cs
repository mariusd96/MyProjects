...
{
    public partial class TCS_AmericaS : Form
    {
        Bitmap[] bp = new Bitmap[20];//vectorul de imagini
        ...
        public TCS_AmericaS()
        {
            ...
            for (int i = 1; i <= 13; i++)
            {
                bp[i] = new Bitmap("Resurse/harti+steaguri/AmericaS/imagine" + i.ToString() + ".png");
        ...
        private void done_Click(object sender, EventArgs e)
        {
            if (x == 1)
            {
                ...
                {//cand n este 14 inseamna ca am parcurs toate tarile
                    ...
                    steag.BackgroundImage = Properties.Resources.machu_picchu1;//la final o imagine reprezentativa pt America de Sud
